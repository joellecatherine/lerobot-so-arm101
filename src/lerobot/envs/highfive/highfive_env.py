...
CONTACT_BONUS = 100.0  # One-time terminal bonus for contact
...
class HighFiveEnv(gym.Env):
    ...
    def __init__(
        ...
        force_disturbance_interval: tuple[int, int] = (10, 40),
        force_disturbance_duration: int = 8,
        force_kicks_per_episode: int = 3,
